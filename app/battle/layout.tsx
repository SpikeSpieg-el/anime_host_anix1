...
export const metadata: Metadata = {
  title: "Weebx — PvP-арена аниме битв. Сразись и возглавь рейтинг",
  description: "Участвуй в PvP-сражениях с аниме-персонажами! Рейтинговая система, награды за победы, таблица лидеров. Собери команду и стань чемпионом на Weebx!",
  keywords: [
    "пвп арена",
    "аниме битвы",
    "рейтинг бойцов",
