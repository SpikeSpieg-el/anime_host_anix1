...
export const TERRITORY_MODIFIERS = [
  ...
  // === ПРАВИЛА РЕДКОСТИ И СТОИМОСТИ ===
  { id: "underdog_triumph", name: "Триумф аутсайдера", nameRu: "Триумф аутсайдера", description: "Карта с наименьшим значением стоимости на этой линии получает бонус +250 к силе." },
  { id: "heavy_weight", name: "Тяжелая артиллерия", nameRu: "Тяжелая артиллерия", description: "Карты со стоимостью 10 и более очков удваивают свою силу на этой линии." },
  ...
  { id: "asceticism", name: "Аскетизм", nameRu: "Аскетизм", description: "Карты со стоимостью 4 и менее очков получают +150 к силе." },
  ...
  { id: "last_stand", name: "Последний рубеж", nameRu: "Последний рубеж", description: "Если у игрока осталось менее 15% здоровья, его карты на этой линии получают +250 к силе." },
