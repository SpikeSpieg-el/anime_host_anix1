...
interface BattleAILocationMetric {
  dungeon_id: string
  battles: number
  wins: number
  losses: number
...
export default function AdminPage() {
  const [activeTab, setActiveTab] = useState<'users' | 'pvp' | 'ai_battle' | 'battle_logs' | 'cards' | 'mail' | 'events' | 'tutorial'>('users')
  ...
  useEffect(() => {
    ...
    if (activeTab === 'ai_battle' && !battleAIDashboard && isAuthenticated) {
      fetchBattleAIDashboard()
    }
      ...
      <div className="max-w-7xl mx-auto p-3 sm:p-4 md:p-6 lg:p-8">
        ...
        <div className="flex flex-col gap-4 mb-6 md:mb-8">
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1 scrollbar-thin">
              ...
              <button
                onClick={() => setActiveTab('ai_battle')}
                className={`text-xs sm:text-sm px-3 sm:px-4 py-2 rounded-lg transition whitespace-nowrap ${activeTab === 'ai_battle' ? 'bg-primary text-primary-foreground font-semibold' : 'text-muted-foreground hover:bg-muted'}`}
              >
                AI Battle
              </button>
              <button
        ...
        {activeTab === 'users' ? (
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <button
                onClick={fetchBattleAIDashboard}
