...
io.on('connection', (socket) => {
  ...
  socket.on('join_queue', async (data) => {
    try {
      ...
      // Get user's MMR from database (use maybeSingle to handle missing row)
