      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <a className="flex items-center gap-3 z-50 group" href="/">
          <div className="relative w-9 h-9 flex items-center justify-center">
            ...
            <div className="relative w-full h-full bg-gradient-to-br from-muted to-card border border-border rounded-xl flex items-center justify-center shadow-2xl">
              <Zap className="w-5 h-5 text-orange-500 fill-orange-500" />
            </div>
          </div>
          <div className="flex flex-col justify-center">
            <h1 className="text-xl font-black tracking-tighter text-foreground leading-none font-unbounded">Weeb.<span className="text-orange-500">X</span></h1>
            <span className="text-[9px] font-bold tracking-[0.2em] text-muted-foreground uppercase leading-none group-hover:text-foreground transition-colors">Stream</span>
          </div>
        </a>
