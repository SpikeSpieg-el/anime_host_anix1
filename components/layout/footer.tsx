          ...
          <div className="space-y-6">
            <a className="flex items-center gap-3 group" href="/">
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest dark:text-zinc-700">WEEB-X STREAM</span>
              </div>
            </a>
      ...
      <div className="border-t border-border dark:border-white/5">
        <div className="container mx-auto px-3 sm:px-4">
          <div className="py-6 sm:py-8 flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
            <p className="text-muted-foreground text-[9px] sm:text-[10px] font-bold tracking-widest uppercase text-center md:text-left dark:text-zinc-600">© {currentYear} Weebx STREAM | WEEBX. MADE BY ANIME FANS FOR ANIME FANS.</p>
