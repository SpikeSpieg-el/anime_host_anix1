    ...
    <section className="mb-16 scroll-mt-32">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Полный гайд для новичков Weeb.x</p>
        </div>
      </div>
      ...
      <div className="bg-secondary/40 border rounded-2xl p-6 sm:p-8 dark:bg-zinc-900/40 dark:border-zinc-800">
        <div className="space-y-6 text-sm sm:text-base text-muted-foreground leading-relaxed dark:text-zinc-300">
          <div>
            ...
            <p>
              Добро пожаловать в Weeb.x! Регистрация займёт минуту — просто укажи email и пароль. После входа ты получишь стартовый пакет с бесплатной гача-круткой. Это твой шанс получить первого легендарного героя без затрат! Не забудь проверить почту для подтверждения аккаунта — это откроет доступ ко всем функциям.
            </p>
          </div>
